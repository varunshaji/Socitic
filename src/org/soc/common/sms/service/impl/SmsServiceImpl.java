package org.soc.common.sms.service.impl;
...
public class SmsServiceImpl implements SmsService {
    ...
    public static final String USERNAME = "52db065b";
    public static final String PASSWORD = "9275f70c";
    public static final String SMS_FROM = "5051";

	public void sendSms(String sno, String stext){
        ...
        TextMessage message = new TextMessage(SMS_FROM, sno, stext);
        // Use the Nexmo client top submit the Text Message ...
